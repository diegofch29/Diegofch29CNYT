...
public class Proyecto {
     ...
     * @return
     */
    public static Numero_complejo New_complex(double a,double b){
        Numero_complejo numero_complejo = new Numero_complejo(a,b);
        return numero_complejo;
    }    
    
    public static Numero_complejo sumar(Numero_complejo a,Numero_complejo b){
        Numero_complejo result= new Numero_complejo();
        result=a.sumar(b);
        return result;
    }
    public static Numero_complejo Multiplicar(Numero_complejo a,Numero_complejo b){
        Numero_complejo result= new Numero_complejo();
        result=a.Multiplicar(b);
        return result;
    }
    
    public static Numero_complejo Restar(Numero_complejo a,Numero_complejo b){
        Numero_complejo result= new Numero_complejo();
        result=a.Restar(b);
        return result;
    }
    
    public static Numero_complejo Dividir(Numero_complejo a,Numero_complejo b){
        Numero_complejo result= new Numero_complejo();
        result=a.Dividir(b);
        return result;
    }
    public static double Modulo(Numero_complejo a){
        return a.Modulo();
    }
    
    public static Numero_complejo Conjugado(Numero_complejo a){
       return  a.Conjugado();
   }
    
    public static Numero_complejo Cartesianas_polares(Numero_complejo a){
        return a.Cartecianas_Polares();
    }
    
    public static Numero_complejo polares_Cartesianas(Numero_complejo a){
        return a.Polares_Cartecianas();
    }
    
    public static Vector New_Vector(Numero_complejo[] Elem,int n){
        return new Vector(Elem, n); 
    }
    
    public static Vector  SumarVectores(Vector a, Vector b){
        return a.Sumar(b);
    }
